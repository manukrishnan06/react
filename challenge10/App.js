    ...
    return(
      <View style={styles.container}>
       <ImageBackground source={require('./assests/image.jpg')} style={styles.background_image}>
        ...
        <Text style={styles.textview}>Hello Its Manu here,Please Register</Text>
      ...
      marginTop:50,
      color:"red",
      padding:20}}placeholder='Country Code' placeholderTextColor="green">
          
        </TextInput>
        <TextInput style={styles.inputview} 
        placeholder='Mobile Number' placeholderTextColor="green">
